...
func (fake *FakeNodeRecorder) CreateOne(arg1 context.Context, arg2 model.CreateNodeParams) (model.Node, error) {
...
func (fake *FakeNodeRecorder) CreateOneCallCount() int {
	fake.createOneMutex.RLock()
	defer fake.createOneMutex.RUnlock()
	return len(fake.createOneArgsForCall)
}

func (fake *FakeNodeRecorder) CreateOneCalls(stub func(context.Context, model.CreateNodeParams) (model.Node, error)) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
	fake.CreateOneStub = stub
}

func (fake *FakeNodeRecorder) CreateOneArgsForCall(i int) (context.Context, model.CreateNodeParams) {
	fake.createOneMutex.RLock()
	defer fake.createOneMutex.RUnlock()
...
func (fake *FakeNodeRecorder) CreateOneReturns(result1 model.Node, result2 error) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
...
func (fake *FakeNodeRecorder) CreateOneReturnsOnCall(i int, result1 model.Node, result2 error) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
	fake.CreateOneStub = nil
...
func (fake *FakeNodeRecorder) DeleteOne(arg1 context.Context, arg2 string) error {
...
func (fake *FakeNodeRecorder) DeleteOneCallCount() int {
	fake.deleteOneMutex.RLock()
	defer fake.deleteOneMutex.RUnlock()
	return len(fake.deleteOneArgsForCall)
}

func (fake *FakeNodeRecorder) DeleteOneCalls(stub func(context.Context, string) error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
	fake.DeleteOneStub = stub
}

func (fake *FakeNodeRecorder) DeleteOneArgsForCall(i int) (context.Context, string) {
	fake.deleteOneMutex.RLock()
	defer fake.deleteOneMutex.RUnlock()
...
func (fake *FakeNodeRecorder) DeleteOneReturns(result1 error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
...
func (fake *FakeNodeRecorder) DeleteOneReturnsOnCall(i int, result1 error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
	fake.DeleteOneStub = nil
...
func (fake *FakeNodeRecorder) FindOne(arg1 context.Context, arg2 string) (model.Node, error) {
...
func (fake *FakeNodeRecorder) FindOneCallCount() int {
	fake.findOneMutex.RLock()
	defer fake.findOneMutex.RUnlock()
	return len(fake.findOneArgsForCall)
}

func (fake *FakeNodeRecorder) FindOneCalls(stub func(context.Context, string) (model.Node, error)) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
	fake.FindOneStub = stub
}

func (fake *FakeNodeRecorder) FindOneArgsForCall(i int) (context.Context, string) {
	fake.findOneMutex.RLock()
	defer fake.findOneMutex.RUnlock()
...
func (fake *FakeNodeRecorder) FindOneReturns(result1 model.Node, result2 error) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
...
func (fake *FakeNodeRecorder) FindOneReturnsOnCall(i int, result1 model.Node, result2 error) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
	fake.FindOneStub = nil
...
func (fake *FakeNodeRecorder) GetList(arg1 context.Context, arg2 int64) ([]model.Node, error) {
...
func (fake *FakeNodeRecorder) GetListCallCount() int {
	fake.getListMutex.RLock()
	defer fake.getListMutex.RUnlock()
	return len(fake.getListArgsForCall)
}

func (fake *FakeNodeRecorder) GetListCalls(stub func(context.Context, int64) ([]model.Node, error)) {
	fake.getListMutex.Lock()
	defer fake.getListMutex.Unlock()
	fake.GetListStub = stub
}

func (fake *FakeNodeRecorder) GetListArgsForCall(i int) (context.Context, int64) {
	fake.getListMutex.RLock()
	defer fake.getListMutex.RUnlock()
...
func (fake *FakeNodeRecorder) GetListReturns(result1 []model.Node, result2 error) {
	fake.getListMutex.Lock()
	defer fake.getListMutex.Unlock()
...
func (fake *FakeNodeRecorder) GetListReturnsOnCall(i int, result1 []model.Node, result2 error) {
	fake.getListMutex.Lock()
	defer fake.getListMutex.Unlock()
	fake.GetListStub = nil
...
func (fake *FakeNodeRecorder) UpdateOne(arg1 context.Context, arg2 model.UpdateNodeParams) error {
...
func (fake *FakeNodeRecorder) UpdateOneCallCount() int {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
	return len(fake.updateOneArgsForCall)
}

func (fake *FakeNodeRecorder) UpdateOneCalls(stub func(context.Context, model.UpdateNodeParams) error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = stub
}

func (fake *FakeNodeRecorder) UpdateOneArgsForCall(i int) (context.Context, model.UpdateNodeParams) {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
...
func (fake *FakeNodeRecorder) UpdateOneReturns(result1 error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
...
func (fake *FakeNodeRecorder) UpdateOneReturnsOnCall(i int, result1 error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = nil
...
func (fake *FakeNodeRecorder) Invocations() map[string][][]interface{} {
...
func (fake *FakeNodeRecorder) recordInvocation(key string, args []interface{}) {
...
var _ recorder.NodeRecorder = new(FakeNodeRecorder)
