...
type FakeFlowRepository struct {
	...
	FindOneStub        func(context.Context, int64) (model.Flow, error)
	...
	UpdateOneStub        func(context.Context, model.UpdateFlowParams) error
	updateOneMutex       sync.RWMutex
	updateOneArgsForCall []struct {
		arg1 context.Context
		arg2 model.UpdateFlowParams
	}
...
func (fake *FakeFlowRepository) CreateOne(arg1 context.Context, arg2 model.CreateFlowParams) (model.Flow, error) {
...
func (fake *FakeFlowRepository) CreateOneCallCount() int {
	fake.createOneMutex.RLock()
	defer fake.createOneMutex.RUnlock()
	return len(fake.createOneArgsForCall)
}

func (fake *FakeFlowRepository) CreateOneCalls(stub func(context.Context, model.CreateFlowParams) (model.Flow, error)) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
	fake.CreateOneStub = stub
}

func (fake *FakeFlowRepository) CreateOneArgsForCall(i int) (context.Context, model.CreateFlowParams) {
	fake.createOneMutex.RLock()
	defer fake.createOneMutex.RUnlock()
...
func (fake *FakeFlowRepository) CreateOneReturns(result1 model.Flow, result2 error) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
...
func (fake *FakeFlowRepository) CreateOneReturnsOnCall(i int, result1 model.Flow, result2 error) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
	fake.CreateOneStub = nil
...
func (fake *FakeFlowRepository) DeleteOne(arg1 context.Context, arg2 int64) error {
...
func (fake *FakeFlowRepository) DeleteOneCallCount() int {
	fake.deleteOneMutex.RLock()
	defer fake.deleteOneMutex.RUnlock()
	return len(fake.deleteOneArgsForCall)
}

func (fake *FakeFlowRepository) DeleteOneCalls(stub func(context.Context, int64) error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
	fake.DeleteOneStub = stub
}

func (fake *FakeFlowRepository) DeleteOneArgsForCall(i int) (context.Context, int64) {
	fake.deleteOneMutex.RLock()
	defer fake.deleteOneMutex.RUnlock()
...
func (fake *FakeFlowRepository) DeleteOneReturns(result1 error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
...
func (fake *FakeFlowRepository) DeleteOneReturnsOnCall(i int, result1 error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
	fake.DeleteOneStub = nil
...
func (fake *FakeFlowRepository) FindOne(arg1 context.Context, arg2 int64) (model.Flow, error) {
...
func (fake *FakeFlowRepository) FindOneCallCount() int {
	fake.findOneMutex.RLock()
	defer fake.findOneMutex.RUnlock()
	return len(fake.findOneArgsForCall)
}

func (fake *FakeFlowRepository) FindOneCalls(stub func(context.Context, int64) (model.Flow, error)) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
	fake.FindOneStub = stub
}

func (fake *FakeFlowRepository) FindOneArgsForCall(i int) (context.Context, int64) {
	fake.findOneMutex.RLock()
	defer fake.findOneMutex.RUnlock()
...
func (fake *FakeFlowRepository) FindOneReturns(result1 model.Flow, result2 error) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
...
func (fake *FakeFlowRepository) FindOneReturnsOnCall(i int, result1 model.Flow, result2 error) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
	fake.FindOneStub = nil
...
func (fake *FakeFlowRepository) GetListCallCount() int {
...
func (fake *FakeFlowRepository) GetListReturnsOnCall(i int, result1 []model.Flow, result2 error) {
	fake.getListMutex.Lock()
	defer fake.getListMutex.Unlock()
	fake.GetListStub = nil
...
func (fake *FakeFlowRepository) UpdateOne(arg1 context.Context, arg2 model.UpdateFlowParams) error {
...
func (fake *FakeFlowRepository) UpdateOneCallCount() int {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
	return len(fake.updateOneArgsForCall)
}

func (fake *FakeFlowRepository) UpdateOneCalls(stub func(context.Context, model.UpdateFlowParams) error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = stub
}

func (fake *FakeFlowRepository) UpdateOneArgsForCall(i int) (context.Context, model.UpdateFlowParams) {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
...
func (fake *FakeFlowRepository) UpdateOneReturns(result1 error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
...
func (fake *FakeFlowRepository) UpdateOneReturnsOnCall(i int, result1 error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = nil
...
func (fake *FakeFlowRepository) Invocations() map[string][][]interface{} {
...
func (fake *FakeFlowRepository) recordInvocation(key string, args []interface{}) {
...
var _ repository.FlowRepository = new(FakeFlowRepository)
