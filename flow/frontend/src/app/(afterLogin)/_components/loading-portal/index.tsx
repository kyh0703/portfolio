...
export default function LoadingPortal() {
  ...
  return (
    ...
    createPortal(
      <div className="fixed left-0 top-0 z-50 flex h-screen w-screen items-center justify-center bg-white bg-opacity-50 dark:bg-black dark:bg-opacity-50">
        <div className="flex flex-col items-center space-y-10 rounded-lg bg-dialog px-24 py-12 shadow-xl">
          <LoadingIcon width={60} height={60} className="animate-spin" />
