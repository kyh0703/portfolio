...
export default function PacketRegisterForm({ scope }: { scope: DefineScope }) {
  ...
  const [watchId, watchComFormat] = useWatch({
    control,
    name: ['id', 'comFormat'],
  })

  const addMutation = useAddDefine<DefinePacket>('packet')
