...
import AssignPacketDataTab from '../../../node-tabs/assign-packet-data-tab'
import GeneralTab from '../../../node-tabs/general-tab'
import LinkTab from '../../../node-tabs/link-tab'
import PacketCallInfoTab from '../../../node-tabs/packet-call-info-tab'
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'packetInfo':
      return <PacketCallInfoTab {...props} />
    case 'packetData':
      return <AssignPacketDataTab {...props} />
    case 'tracking':
