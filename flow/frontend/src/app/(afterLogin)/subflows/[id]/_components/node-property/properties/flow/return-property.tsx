...
import ReturnInfoTab from '../../../node-tabs/return-info-tab'
import { RETURN_INFO_TAB_SCHEMA } from '../../../node-tabs/validator'
import type { NodePropertyTabProps } from '../../types'

const schema = RETURN_INFO_TAB_SCHEMA
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'value':
      return <ReturnInfoTab {...props} />
    default:
      return null
  }
}

export default function ReturnProperty(props: NodePropertyTabProps) {
