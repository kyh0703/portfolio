...
import QueryInfoTab from '../../node-tabs/expert/query-info-tab'
import TrackingTab from '../../node-tabs/expert/tracking-tab'
import type { NodePropertyTabProps } from '../types'
import { QUERY_INFO_TAB_SCHEMA, TRACKING_TAB_SCHEMA } from '../validator'

const schema = Yup.object()
  .concat(QUERY_INFO_TAB_SCHEMA)
...
export default function DBQueryProperty(props: NodePropertyTabProps) {
