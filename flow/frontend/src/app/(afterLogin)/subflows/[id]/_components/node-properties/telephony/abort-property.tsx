...
import BeginnerAbortInfoTab from '../../node-tabs/beginner/abort-info-tab'
import BeginnerTrackingTab from '../../node-tabs/beginner/tracking-tab'
import AbortInfoTab from '../../node-tabs/expert/abort-info-tab'
...
import { ABORT_INFO_TAB_SCHEMA, TRACKING_TAB_SCHEMA } from '../validator'

const schema = Yup.object()
  .concat(ABORT_INFO_TAB_SCHEMA)
...
export default function AbortProperty(props: NodePropertyTabProps) {
