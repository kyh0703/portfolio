...
import MenuReturnInfoTab from '../../../node-tabs/menu-return-info-tab'
import { MENU_RETURN_INFO_TAB_SCHEMA } from '../../../node-tabs/validator'
import type { NodePropertyTabProps } from '../../types'

const schema = MENU_RETURN_INFO_TAB_SCHEMA
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'info':
      return <MenuReturnInfoTab {...props} />
    default:
      return null
  }
}

export default function MenuReturnProperty(props: NodePropertyTabProps) {
