...
import RouteACDTab from '../../../node-tabs/route-acd-tab'
import { ROUTE_ACD_TAB_SCHEMA } from '../../../node-tabs/validator'
import type { NodePropertyTabProps } from '../../types'

const schema = ROUTE_ACD_TAB_SCHEMA
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'routeInfo':
      return <RouteACDTab {...props} />
    default:
      return null
  }
}

export default function RouteAcdProperty(props: NodePropertyTabProps) {
