...
import MenuStatInfoTab from '../../node-tabs/expert/menu-stat-info-tab'
...
const renderTabContent = (props: NodePropertyTabProps) => {
  ...
  const expertTabs: Partial<Record<TabKeys, JSX.Element>> = {
    ...
    info: <MenuStatInfoTab {...props} />,
  }

  return expertTabs[tabKeys]
}

export default function UserMenuStatProperty(props: NodePropertyTabProps) {
