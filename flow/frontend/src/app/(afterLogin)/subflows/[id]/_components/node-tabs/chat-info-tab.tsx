...
import ChatInfoModal from '../node-modals/chat-info-modal'
...
export default function ChatInfoTab(props: NodePropertyTabProps) {
  const { tabName } = props
  ...
  const handleModalSubmit = (mode: 'create' | 'update', data: CodeData) => {
    if (mode === 'create') {
      addRow(data)
    } else {
