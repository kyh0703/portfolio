...
import ToneInfoTab from '../../node-tabs/expert/tone-info-tab'
import TrackingTab from '../../node-tabs/expert/tracking-tab'
import type { NodePropertyTabProps } from '../types'
import { TONE_INFO_TAB_SCHEMA, TRACKING_TAB_SCHEMA } from '../validator'

const schema = Yup.object()
  .concat(TONE_INFO_TAB_SCHEMA)
...
export default function PushToneProperty(props: NodePropertyTabProps) {
