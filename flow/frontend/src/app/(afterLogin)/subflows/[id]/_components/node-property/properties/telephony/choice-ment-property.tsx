...
import MentTypeTab from '../../../node-tabs/ment-type-tab'
import { MENT_TYPE_TAB_SCHEMA } from '../../../node-tabs/validator'
import type { NodePropertyTabProps } from '../../types'

const schema = MENT_TYPE_TAB_SCHEMA
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'mentType':
      return <MentTypeTab {...props} />
    default:
      return null
  }
}

export default function ChoiceMentProperty(props: NodePropertyTabProps) {
