...
import BeginnerCallInfoTab from '../../node-tabs/beginner/call-info-tab'
import BeginnerTrackingTab from '../../node-tabs/beginner/tracking-tab'
import CallInfoTab from '../../node-tabs/expert/call-info-tab'
...
import { CALL_INFO_TAB_SCHEMA, TRACKING_TAB_SCHEMA } from '../validator'

const schema = Yup.object()
  .concat(CALL_INFO_TAB_SCHEMA)
...
export default function MakeCallProperty(props: NodePropertyTabProps) {
