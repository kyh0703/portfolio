...
import SetEventInfoTab from '../../node-tabs/expert/set-event-info-tab'
import TrackingTab from '../../node-tabs/expert/tracking-tab'
import type { NodePropertyTabProps } from '../types'
import { SET_EVENT_INFO_TAB_SCHEMA, TRACKING_TAB_SCHEMA } from '../validator'
