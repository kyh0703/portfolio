...
import PacketSizeInfoTab from '../../node-tabs/expert/packet-size-info-tab'
import type { NodePropertyTabProps } from '../types'
import { PACKET_SIZE_INFO_TAB_SCHEMA } from '../validator'

const schema = PACKET_SIZE_INFO_TAB_SCHEMA
...
const renderTabContent = (props: NodePropertyTabProps) => {
  ...
  const expertTabs: Partial<Record<TabKeys, JSX.Element>> = {
    ...
    packetInfo: <PacketSizeInfoTab {...props} />,
  }

  return expertTabs[tabKeys]
}

export default function PacketSizeProperty(props: NodePropertyTabProps) {
