...
import DetectInfoTab from '../../node-tabs/expert/detect-info-tab'
...
import { DETECT_INFO_TAB_SCHEMA, TRACKING_TAB_SCHEMA } from '../validator'

const schema = Yup.object()
  .concat(DETECT_INFO_TAB_SCHEMA)
...
export default function ToneDetectProperty(props: NodePropertyTabProps) {
