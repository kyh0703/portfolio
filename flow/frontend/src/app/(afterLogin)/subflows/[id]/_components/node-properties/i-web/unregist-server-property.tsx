...
import BeginnerUnregInfoTab from '../../node-tabs/beginner/unreg-info-tab'
import GeneralTab from '../../node-tabs/expert/general-tab'
import TrackingTab from '../../node-tabs/expert/tracking-tab'
import UnregInfoTab from '../../node-tabs/expert/unreg-info-tab'
import type { NodePropertyTabProps } from '../types'
import { TRACKING_TAB_SCHEMA, UNREG_INFO_TAB_SCHEMA } from '../validator'

const schema = Yup.object()
  .concat(UNREG_INFO_TAB_SCHEMA)
...
export default function UnregistServerProperty(props: NodePropertyTabProps) {
