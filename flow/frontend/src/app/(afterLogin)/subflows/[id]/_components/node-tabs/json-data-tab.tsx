...
import JsonDataModal from '../node-modals/json-data-modal'
...
export default function JsonDataTab(props: NodePropertyTabProps) {
  ...
  const handleModalSubmit = (mode: 'create' | 'update', data: JsonData) => {
    if (mode === 'create') {
      addRow(data)
    } else {
