...
import RouteQueueRuleTab from '../../node-tabs/expert/route-queue-rule-tab'
import type { NodePropertyTabProps } from '../types'
import { ROUTE_INFO_TAB_SCHEMA } from '../validator'

const schema = ROUTE_INFO_TAB_SCHEMA
...
const renderTabContent = (props: NodePropertyTabProps) => {
  ...
  const expertTabs: Partial<Record<TabKeys, JSX.Element>> = {
    ...
    routeInfo: <RouteQueueRuleTab {...props} />,
  }

  return expertTabs[tabKeys]
}

export default function RouteQueueRuleProperty(props: NodePropertyTabProps) {
