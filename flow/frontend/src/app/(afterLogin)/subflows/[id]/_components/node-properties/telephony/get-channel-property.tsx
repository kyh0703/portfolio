...
import BeginnerChannelInfoTab from '../../node-tabs/beginner/channel-info-tab'
import BeginnerTrackingTab from '../../node-tabs/beginner/tracking-tab'
import ChannelInfoTab from '../../node-tabs/expert/channel-info-tab'
...
import { CHANNEL_INFO_TAB_SCHEMA, TRACKING_TAB_SCHEMA } from '../validator'

const schema = Yup.object()
  .concat(CHANNEL_INFO_TAB_SCHEMA)
...
export default function GetChannelProperty(props: NodePropertyTabProps) {
