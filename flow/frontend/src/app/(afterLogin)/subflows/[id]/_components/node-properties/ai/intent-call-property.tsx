...
import BeginnerIntentInfoTab from '../../node-tabs/beginner/intent-info-tab'
...
import IntentInfoTab from '../../node-tabs/expert/intent-info-tab'
...
import { INTENT_INFO_TAB_SCHEMA, TRACKING_TAB_SCHEMA } from '../validator'

const schema = Yup.object()
  .concat(INTENT_INFO_TAB_SCHEMA)
...
const renderTabContent = (props: NodePropertyTabProps) => {
  ...
  const beginnerTabs: Partial<Record<TabKeys, JSX.Element>> = {
    intentInfo: <BeginnerIntentInfoTab {...props} />,
  ...
  const expertTabs: Partial<Record<TabKeys, JSX.Element>> = {
    ...
    intentInfo: <IntentInfoTab {...props} />,
...
export default function IntentCallProperty(props: NodePropertyTabProps) {
