...
import BeginnerInboundInfoTab from '../../node-tabs/beginner/inbound-info-tab'
import GeneralTab from '../../node-tabs/expert/general-tab'
import InboundInfoTab from '../../node-tabs/expert/inbound-info-tab'
import type { NodePropertyTabProps } from '../types'
import { INBOUND_INFO_TAB_SCHEMA } from '../validator'
