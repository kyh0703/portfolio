...
import HttpDataTab from '../../../node-tabs/http-data-tab'
import RequestInfoTab from '../../../node-tabs/request-info-tab'
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'requestInfo':
      return <RequestInfoTab {...props} />
    case 'httpData':
      return <HttpDataTab {...props} />
    case 'tracking':
