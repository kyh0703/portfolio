...
import ParseInfoTab from '../../../node-tabs/parse-info-tab'
import { PARSE_INFO_TAB_SCHEMA } from '../../../node-tabs/validator'
import type { NodePropertyTabProps } from '../../types'

const schema = PARSE_INFO_TAB_SCHEMA

const tabMap = {
  general: 'General',
  parserInfo: 'Parse Info',
} as const
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'parserInfo':
      return <ParseInfoTab {...props} />
    default:
      return null
  }
}

export default function StringParserProperty(props: NodePropertyTabProps) {
