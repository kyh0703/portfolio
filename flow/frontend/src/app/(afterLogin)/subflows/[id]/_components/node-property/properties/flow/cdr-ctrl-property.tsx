...
import CdrControlTab from '../../../node-tabs/cdr-control-tab'
import GeneralTab from '../../../node-tabs/general-tab'
import { CDR_CONTROL_TAB_SCHEMA } from '../../../node-tabs/validator'
import type { NodePropertyTabProps } from '../../types'

const schema = CDR_CONTROL_TAB_SCHEMA

const tabMap = {
  general: 'General',
  ctrlInfo: 'CDR Control',
} as const
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'ctrlInfo':
      return <CdrControlTab {...props} />
    default:
      return null
  }
}

export default function CdrCtrlProperty(props: NodePropertyTabProps) {
