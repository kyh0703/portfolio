...
import WaitEventInfoTab from '../../node-tabs/expert/wait-event-info-tab'
import type { NodePropertyTabProps } from '../types'
import { TRACKING_TAB_SCHEMA, WAIT_EVENT_INFO_TAB_SCHEMA } from '../validator'

const schema = Yup.object()
  .concat(WAIT_EVENT_INFO_TAB_SCHEMA)
...
export default function WaitEventProperty(props: NodePropertyTabProps) {
