...
import HtmlInputModal from '../node-modals/html-info-modal'
import InputObjectModal from '../node-modals/input-object-modal'
...
export default function HTMLInfoTab(props: NodePropertyTabProps) {
  ...
  const {
    ...
    getSelectedRow: getSelectedParameterRow,
  ...
  const [parameterContextMenu, setParameterContextMenu, onParameterCellContextMenu] = useGridContext()
  ...
  const {
    ...
    getSelectedRow: getSelectedInputObjectRow,
  ...
  const [inputObjectContextMenu, setInputObjectContextMenu, onInputObjectCellContextMenu] = useGridContext()
  ...
  const handleParameterModalSubmit = (
    ...
    if (mode === 'create') {
      ...
      updateParameterRowByRowIndex(data, getSelectedParameterRow()?.rowIndex)
    }
    submitButtonRef.current?.click()
  }
  ...
  const handleInputObjectModalSubmit = (
    ...
    if (mode === 'create') {
      ...
      updateInputObjectRowByRowIndex(
        data,
        getSelectedInputObjectRow()?.rowIndex,
      )
    }
    submitButtonRef.current?.click()
  }
