...
import BeginnerObjectInfoTab from '../../node-tabs/beginner/object-info-tab'
import BeginnerTrackingTab from '../../node-tabs/beginner/tracking-tab'
import GeneralTab from '../../node-tabs/expert/general-tab'
import ObjectInfoTab from '../../node-tabs/expert/object-info-tab'
import TrackingTab from '../../node-tabs/expert/tracking-tab'
import type { NodePropertyTabProps } from '../types'
import { OBJECT_INFO_TAB_SCHEMA, TRACKING_TAB_SCHEMA } from '../validator'

const schema = Yup.object()
  .concat(OBJECT_INFO_TAB_SCHEMA)
...
export default function GetPageDataProperty(props: NodePropertyTabProps) {
