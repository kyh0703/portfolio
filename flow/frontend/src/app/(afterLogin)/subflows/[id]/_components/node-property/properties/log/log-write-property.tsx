...
import LogInfoTab from '../../../node-tabs/log-info-tab'
import { LOG_INFO_TAB_SCHEMA } from '../../../node-tabs/validator'
import type { NodePropertyTabProps } from '../../types'

const schema = LOG_INFO_TAB_SCHEMA
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'info':
      return <LogInfoTab {...props} />
    default:
      return null
  }
}

export default function LogWriteProperty(props: NodePropertyTabProps) {
