...
import CTIInfoTab from '../../../node-tabs/cti-info-tab'
import GeneralTab from '../../../node-tabs/general-tab'
import InputTab from '../../../node-tabs/input-tab'
import OutputTab from '../../../node-tabs/output-tab'
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'info':
      return <CTIInfoTab {...props} />
    case 'input':
      return <InputTab {...props} />
    case 'output':
