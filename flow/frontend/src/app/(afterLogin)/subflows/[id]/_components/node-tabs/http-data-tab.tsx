...
import HttpDataModal from '../node-modals/http-data-modal'
...
export default function HttpDataTab(props: NodePropertyTabProps) {
  ...
  const {
    ...
    addRow: addHeadRow,
    getRows: getHeadRows,
    getSelectedRow: getSelectedHeadRow,
  ...
  const [headContextMenu, setHeadContextMenu, onHeadCellContextMenu] = useGridContext()
  ...
  const {
    ...
    addRow: addBodyRow,
    getRows: getBodyRows,
    getSelectedRow: getSelectedBodyRow,
  ...
  const [bodyContextMenu, setBodyContextMenu, onBodyCellContextMenu] = useGridContext()
  ...
  const handleRowDoubleClicked = (
    ...
    openModal('property-modal', { mode: 'update', type, data: event.data })
  }
  ...
  const handleModalSubmit = (
    ...
    if (type === 'head' && mode === 'create') addHeadRow(data)
      ...
      updateHeadRowByRowIndex(data, getSelectedHeadRow()?.rowIndex)
    else if (type === 'body' && mode === 'create') addBodyRow(data)
    else if (type === 'head' && mode === 'update')
      updateBodyRowByRowIndex(data, getSelectedBodyRow()?.rowIndex)
  }
