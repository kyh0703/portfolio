...
import DisSwitchInfoTab from '../../../node-tabs/dis-switch-info-tab'
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'info':
      return <DisSwitchInfoTab {...props} />
    default:
      return null
  }
}

export default function ChoiceCallProperty(props: NodePropertyTabProps) {
