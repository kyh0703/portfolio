...
import ConsumerInfoTab from '../../../node-tabs/consumer-info-tab'
import GeneralTab from '../../../node-tabs/general-tab'
import { CONSUMER_INFO_TAB_SCHEMA } from '../../../node-tabs/validator'
import type { NodePropertyTabProps } from '../../types'

const schema = CONSUMER_INFO_TAB_SCHEMA
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'info':
      return <ConsumerInfoTab {...props} />
    default:
      return null
  }
}

export default function ConsumerMonitProperty(props: NodePropertyTabProps) {
