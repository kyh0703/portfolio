...
import RouteGroupInfoTab from '../../../node-tabs/route-group-info-tab'
import { ROUTE_GROUP_INFO_TAB_SCHEMA } from '../../../node-tabs/validator'
import type { NodePropertyTabProps } from '../../types'

const schema = ROUTE_GROUP_INFO_TAB_SCHEMA
...
const renderTabContent = (props: NodePropertyTabProps) => {
  switch (props.tabName) {
    ...
    case 'routeInfo':
      return <RouteGroupInfoTab {...props} />
    default:
      return null
  }
}

export default function RouteGroupProperty(props: NodePropertyTabProps) {
