...
import BeginnerRecordInfoTab from '../../node-tabs/beginner/record-info-tab'
import BeginnerTrackingTab from '../../node-tabs/beginner/tracking-tab'
import GeneralTab from '../../node-tabs/expert/general-tab'
import RecordInfoTab from '../../node-tabs/expert/record-info-tab'
import TrackingTab from '../../node-tabs/expert/tracking-tab'
import type { NodePropertyTabProps } from '../types'
import { RECORD_INFO_TAB_SCHEMA, TRACKING_TAB_SCHEMA } from '../validator'

const schema = Yup.object()
  .concat(RECORD_INFO_TAB_SCHEMA)
...
export default function RecordProperty(props: NodePropertyTabProps) {
