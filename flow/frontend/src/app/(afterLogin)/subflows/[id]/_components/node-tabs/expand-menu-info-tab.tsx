...
import ExpandMenuInfoModal from '../node-modals/expand-menu-info-modal'
import { NodePropertyTabProps } from '../node-property/types'

export default function ExpandMenuTab(props: NodePropertyTabProps) {
  ...
  const handleModalSubmit = (mode: 'create' | 'update', data: BranchList) => {
    if (mode === 'create') {
      addRow(data)
    } else {
