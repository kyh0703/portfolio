...
import UserFunctionListModal from '../node-modals/user-function-list-modal'
...
export default function UserFunctionListTab(props: NodePropertyTabProps) {
  ...
  const handleModalSubmit = (mode: 'create' | 'update', data: FuncList) => {
    if (mode === 'create') {
      addRow(data)
    } else {
