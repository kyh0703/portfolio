...
import AssignModal from '../node-modals/assign-modal'
...
export default function AssignTab(props: NodePropertyTabProps) {
  ...
  const handleModalSubmit = (mode: 'create' | 'update', data: AssignList) => {
    if (mode === 'create') {
      addRow(data)
    } else {
  ...
  return (
    <div className="flex h-full w-full flex-col">
      ...
      <Modal id="property-modal" title="Assign Variable">
        <AssignModal tabProps={props} onSubmit={handleModalSubmit} />
      </Modal>
