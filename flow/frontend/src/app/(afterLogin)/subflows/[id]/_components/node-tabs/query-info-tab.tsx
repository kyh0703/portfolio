...
import ResultInfoModal from '../node-modals/argument-modal'
...
export default function QueryInfoTab(props: NodePropertyTabProps) {
  ...
  const {
    ...
    getSelectedRow: getSelectedArgumentDataRow,
  ...
  const {
    ...
    getSelectedRow: getSelectedResultColumnRow,
  ...
  const handleArgumentDataModalSubmit = (payload: {
    ...
    if (mode === 'create') {
      ...
      updateArgumentDataRowByRowIndex(
        data,
        getSelectedArgumentDataRow()?.rowIndex,
      )
    }
  }
  ...
  const handleResultColumnModalSubmit = (payload: {
    ...
    if (mode === 'create') {
      ...
      updateResultColumnRowByRowIndex(
        data,
        getSelectedResultColumnRow()?.rowIndex,
      )
    }
  }
