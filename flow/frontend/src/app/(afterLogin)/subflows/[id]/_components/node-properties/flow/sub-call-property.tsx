...
import BeginnerArgumentInfoTab from '../../node-tabs/beginner/argument-info-tab'
import ArgumentInfoTab from '../../node-tabs/expert/argument-info-tab'
import GeneralTab from '../../node-tabs/expert/general-tab'
import type { NodePropertyTabProps } from '../types'
import { ARGUMENT_INFO_TAB_SCHEMA } from '../validator'

const schema = ARGUMENT_INFO_TAB_SCHEMA
...
export default function SubCallProperty(props: NodePropertyTabProps) {
